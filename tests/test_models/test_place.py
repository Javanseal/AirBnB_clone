#!/usr/bin/python3
"""Describes unittests for models/place.py.
...
class TestPlace_save(unittest.TestCase):
    """The Unittests for testing save method of the Place class."""
...
class TestPlace_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        pl = Place()
        pl.middle_name = "AlxSE"
        pl.my_number = 98
        self.assertEqual("AlxSE", pl.middle_name)
